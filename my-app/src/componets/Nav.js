...
function Nav() {
    ...
    return (
        <section id="navbar_">
            <Link to={"/"}><a className="heading"><img src="logo.png" alt="logo" /></a></Link>
            <div id="navbr">
                <ul id="nav">
                    {
                    ...
                    <li className="hover text" id="men"><Link to={"/men"}>Men</Link></li>
                    <li className="hover text" id="women"><Link to={"/women"}>Women</Link></li>
                    <li className="hover text" id="kid"><Link to={"/kid"}>Kids</Link></li>
                    ...
                    }
                    {
                        auth ? <>
                            <DropdownButton className='drop' variant="secondary" title={"Hi," + Name}>
                                ...
                                <Dropdown.Divider />
                                <Dropdown.Item className='drop_order' onClick={(e)=>{navigate("/vieworder")}}>My Orders</Dropdown.Item>
                                <Dropdown.Divider />
