  ...
  return (
    <div>
    {
      ...
      <section id="discount" className="section_margin">
        <h4>Best Deales</h4>
        <h2>Up to <span>50% off</span> All T-Shirt & Shirt</h2>
      ...
      <section id="fotter_banner_1" className="section_padding">
        <div className="banner-box banner-box1">
          ...
          <span>Over-sized T-Shirts are on sales at Digg-Designer</span>
          <button type="button" className="btn_banner btn_banner1">Buy Now</button>
        </div>
        <div className="banner-box banner-box2">
          <h4>Summer/Winter</h4>
          <h2>Upcomming Season</h2>
          <span>sweat-shirt are available at Digg-Designer</span>
